        ...
        <Row>
          ...
          <Col md={6}>
            <ServiceBox
              ...
              description="Use the thorough market research services offered by Rai Consultancy Services to stay ahead of the curve. We explore consumer behavior, market dynamics, and industry trends to give you practical information that can help you make wise decisions. Your tactics will be precisely calibrated to suit the demands of the constantly changing market thanks to our research-driven methodology."
            />
          </Col>
          ...
          <Col md={6}>
            <ServiceBox
              ...
              description="With the organizational development experience of Rai Consultancy Services, cultivate a vibrant corporate culture. We collaborate closely with your team to promote positive change, strengthen leadership, and improve communication. Our complete strategy gives your company the flexibility, expansion, and success it needs in the fast-paced commercial world of today."
            />
          </Col>
          <Col md={6}>
            <ServiceBox
          ...
          <Col md={6}>
            <ServiceBox
              ...
              description="Use the CRM solutions from Rai Consultancy Services to improve your interactions with your customers. To meet your company's demands, we assist you in implementing and optimizing CRM solutions. Improve client encounters, expedite procedures, and create enduring relationships that spur client loyalty and company expansion."
            />
          </Col>
        </Row>
      </Container>
...
const ServiceBox = ({ title, image, description }) => {
  ...
  return (
    <div className="p-4">
      ...
      <h3 className="mt-3 font-weight-bold text-primary text-center">
        {title}
      </h3>
      <p>{description}</p>
    </div>
